...
export function createSearchFloatingUi({
  ...
  function ensureSearchButton() {
    ...
    button.appendChild(createSvgIcon("search", 15));
  ...
  function ensureSearchPanel() {
    ...
    prevButton.appendChild(createSvgIcon("chevronUp", 12));
    ...
    nextButton.appendChild(createSvgIcon("chevronDown", 12));
    ...
    closeButton.appendChild(createSvgIcon("close", 12));
    ...
    sidebarButton.appendChild(createSvgIcon("openSidebar", 12));
